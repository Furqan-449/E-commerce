...
<body>
    <div class="main-content">
        ...
        <div class="form-container">
            ...
            <form id="clientForm" action="{{ route('editdata', $data->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                {{-- Avatar Upload --}}
                <div class="avatar-upload">
                    <div class="avatar-preview" id="avatarPreview">
                        ...
                        <img src="{{ url('storage/clients/' . $data->image) }}" id="avatarImage" style="display: block;" />
                    </div>
                    ...
                    <div class="form-col">
                        <div class="form-group">
                            ...
                            <select id="company" class="form-control form-select" name="company">
                                ...
                                <option value="Acme Corporation" {{ $data->company == 'Acme Corporation' ? 'selected' : '' }}>
                                    Acme Corporation</option>
                                <option value="Bright Solutions" {{ $data->company == 'Bright Solutions' ? 'selected' : '' }}>
                                    Bright Solutions</option>
                                <option value="Tech Innovators" {{ $data->company == 'Tech Innovators' ? 'selected' : '' }}>
                                    Tech Innovators</option>
                                <option value="Global Designs" {{ $data->company == 'Global Designs' ? 'selected' : '' }}>
                                    Global Designs</option>
                                <option value="North Industries"
                                    {{ $data->company == 'North Industries' ? 'selected' : '' }}>North Industries</option>
                                <option value="other" {{ $data->company == 'other' ? 'selected' : '' }}>Other</option>
                            </select>
                            <span style="color: red">
                                @error('company')
                                    {{ $message }}
