...
<body>
    <div class="main-content">
        ...
        <div class="form-container">
            ...
            <form id="itemForm" action="{{route('update_item',$data->id)}}" method="post" enctype="multipart/form-data">
                @csrf
                {{-- Image Upload --}}
                <div class="avatar-upload">
                    <div class="avatar-preview" id="itemImagePreview">
                        ...
                        <img id="itemImageDisplay" src="{{ asset('storage/items/' . $data->image) }}"
                            style="display: block;" />
                    </div>
                    ...
                    <div class="form-col">
                        <div class="form-group">
                            ...
                            <input type="text" id="sku" class="form-control" placeholder="Enter SKU"
                                name="sku" value="{{ $data->sku }}" readonly>
                            <span style="color: red">
                                @error('sku')
                                    {{ $message }}
                                @enderror
                    ...
                    <div class="form-col">
                        <div class="form-group">
                            ...
                            <input type="number" id="price" class="form-control" placeholder="0.00" step="0.01"
                                min="0" name="price" value="{{ old('price', $data->price) }}">
                            <span style="color: red">
                                @error('price')
                                    {{ $message }}
                                @enderror
                    ...
                    <div class="form-col">
                        <div class="form-group">
                            ...
                            <input type="number" id="stock" class="form-control" placeholder="0" min="0"
                                name="stock" value="{{ old('stock', $data->quantity) }}">
                            <span style="color: red">
                                @error('stock')
                                    {{ $message }}
                                @enderror
    ...
    @vite(['resources/js/items/edit_item.js'])
<script>
